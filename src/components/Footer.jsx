...
export default function Footer() {
  ...
  const contactInfo = [
    {
      icon: <MdEmail />,
      value: "ignatovich.kris96@mail.ru",
    },
    {
      icon: <MdPhoneInTalk />,
      value: "+48 571 046 817",
    },
    {
      icon: <IoLocationSharp />,
      value: "ul. Jedności Narodowej, Wrocław, Poland",
    },
  ];
  const socialIcons = [
    <AiFillFacebook />,
  ...
  return (
    <Container id="footer">
      <div className="row">
        ...
        <p className="description">ul. Jedności Narodowej, Wrocław, Poland</p>
